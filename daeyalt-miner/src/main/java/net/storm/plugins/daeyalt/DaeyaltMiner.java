 ...
 */
@PluginDescriptor(name = "Daeyalt Miner")
@Extension
public class DaeyaltMiner extends LoopedPlugin {
    private ConfigManager conManager;
    private SharedContext context;
    private DaeyaltMinerOverlay overlay;
    ...
    public void onConfigChanged(ConfigChanged event) {
        if (stateMachine != null && context != null) {
            context.setConfig(conManager.getConfig(DaeyaltMinerConfig.class));
        }
    }
    ...
    public void startUp() throws Exception
    {
        ...
        this.overlay = new DaeyaltMinerOverlay(context);
    ...
    @Provides
    DaeyaltMinerConfig provideConfig(ConfigManager configManager) {
        this.conManager = configManager;
        return configManager.getConfig(DaeyaltMinerConfig.class);
    }
}
